...
%% Interface
-export([start/0,subscribe/1,listen/1,add_event/3,terminate/0,cancel/1]).
...
send_to_clients(Msg, ClientDict) ->
  orddict:map(fun(_Ref, Pid) -> Pid ! Msg end, ClientDict). %% Higher order function